...
#source("nemlinplot.R")
source("nemlinplot3.R")       ### USING NEW FILE FOR PLOTTING WITH NONLINEAR COLOR SCALING
...
source(paste(forras1,"/SummaryPlot.R",sep=""))
...
####a csat számot meg a klaszterszámot is jó lenn melléírni....
